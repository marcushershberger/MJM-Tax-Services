...
function generateKeyRequest() {
    ...
    request.onreadystatechange = function() {
        if (request.readyState == 4 && request.status == 200) {
            ...
            var message_data = "Hi, Here is your key " + request.responseText + " to reset your password. You can also visit 10.178.40.49/branch/MJM-Tax-Services/reset_pass.php?key=" + request.responseText;
