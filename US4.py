...
"""US 4:1 User (both) can input a valid phone number with or without dashes in the phone number input box when they are signing up (Issue #27)."""

# EmailRegKey.emailKey()

# Creating url for next part of test
url2 = consts.IP + "signup.php?key=yKqzul9U"
